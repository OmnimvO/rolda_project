...
<div class="page-loader-wrapper">
    ...
    <nav class="navbar" >
        <div class="container-fluid" style="background-color: darkblue;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="includes/index.html">CSIT SKILL DEVELOPMENT SYSTEM</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
    <section>
        ...
        <aside id="leftsidebar" class="sidebar" style="background-color: #f2f2f2;">
            ...
            <div class="menu" >
                <ul class="list">
                    <li class="header" style="background-color: #f2f2f2;">MAIN NAVIGATION</li>
                    <li>
                        ...
                        <a href="category.php" >
                            <i style="color: #0E1BB1" class="material-icons">school</i>
                            <span>Category Record</span>
                        </a>

                        <a href="skills.php" >
                            <i style="color: #0E1BB1" class="material-icons">psychology</i>
                            <span>Skills Record</span>
                        </a>

                        <a href="progress.php" >
                            <i style="color: #0E1BB1" class="material-icons">leaderboard</i>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2023 - 2024 <a href="dashboard.php">CSIT Skill Development System</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
